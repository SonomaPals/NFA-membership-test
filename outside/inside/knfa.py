...
def create_efree_NFA(myNFA):   
    ...
    newNFA = NFA(myNFA.num_states, myNFA.num_symbols) # Create a new NFA with empty transition table
    ...
    newNFA.filled = True # Mark that the NFA has its transition table filled in
